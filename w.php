...
$cpath = hx(__FILE__);
//phpinfo();
require_once $cpath . 'ReCodMod/functions/php_modules_geo_install.php';
...
if (!file_exists($cpath . 'ReCodMod/cache/x_cache/' . $server_ip . '_' . $server_port . '_pos.txt')) require $cpath . 'ReCodMod/functions/install.php';
          ...
          if (((!empty($parseline)) && (preg_match('/;/', $parseline, $z))) || ((!empty($parseline)) && (preg_match('/ExitLevel: executed/', $parseline, $z))) || ((!empty($parseline)) && (preg_match('/ShutdownGame:/', $parseline, $z))) || ((!empty($parseline)) && (preg_match('/InitGame:/', $parseline, $z)))) {
            if ($x_stop_lp == 0) {
              ...
              //%%%%%%%%%%%%%%%%%%%%%%%%  JOIN  %%%%%%%%%%%%%%%%%%%%%%%%
                ...
                require $cpath . 'ReCodMod/plugins_parser/geo.php';
                require $cpath . 'ReCodMod/functions/null_db_connection.php';
              }
              //%%%%%%%%%%%%%%%%%%%%%%%%  QUIT  %%%%%%%%%%%%%%%%%%%%%%%%
              else if (preg_match('/Q;/', $parseline, $u)) {
                require $cpath . 'ReCodMod/plugins_parser/quit.php';
              }
              //%%%%%%%%%%%%%%%%%%%%%%%%  KILL  %%%%%%%%%%%%%%%%%%%%%%%%
