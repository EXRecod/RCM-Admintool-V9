                      ...
                      if (!empty($time)) {
                        if ($poss == 2) {
                          ...
                          if ((((int)$kx + ((time()) - (int)$time)) <= 8) and ((int)$hx == 10)) {
                            ...
                            debuglog((__FILE__)."TEST *** CHEATER? $guid : [$datetime] [time:$time]/[heads:$hx] $server_ip:$server_port \n\n");
                          }
                      ...
                      if ($hstatus == 'heads') {
                        if ($kx > 55) {
                          if (((($dx / $kx) * 100) > 60) && (($kx / $dx) > 2.8)) {
                            ...
                            debuglog((__FILE__)."TEST *** CHEATER? $guid : [$datetime] $cn/$kx/$dx $server_ip:$server_port \n\n");
