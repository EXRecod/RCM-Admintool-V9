  ...
  if (!empty(webhookurl_enable)) {
    if (!empty($reportdisscord)) {
      if (time() - $reportdisscord >= 10) {
        ...
        "color" => hexdec("3366ff") ,
        // Footer
        "footer" => ["text" => "COD4", "icon_url" => "https://raw.githubusercontent.com/EXRecod/RCM-Admintool-V9/master/cfg/languages/favicon.png"],
        // Image to send
        // "image" => [
        ...
        //],
        // Author
        "author" => ["name" => "ReCodMod", "url" => "https://github.com/EXRecod/RCM-Admintool-V9"]]]], JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE);
