 ...
 if($rconstatus == 1)
  ...
  foreach ($rconarray as $j => $e) {
    ...
    $c_guid = '';  
	  ...
	  return $c_ping . ';' . $c_ip . ';' . $c_name . ';' . $c_guid . ';n/a;n/a;n/a'; 
    }
  }
...
function discord_bot($server_ip,$server_port,$nickname,$guidn,$message,$webhook_url) {
   //=======================================================================================================
        ...
        // Message
        //"content" => "Nickname: $nickname / Message : $message",
        // Username
        ...
        "type" => "rich",
        // Embed Description
        "description" => "Nickname: $nickname / Message : $message",
        // URL of title link
