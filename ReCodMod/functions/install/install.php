...
touch($cpath.'ReCodMod/cache/x_cache/'.$server_ip.'_'.$server_port.'_z-vote.log');
touch($cpath.'ReCodMod/cache/x_cache/'.$server_ip.'_'.$server_port.'_z-vote-gametype.log');
...
if($pravanadbchat0 != '0666')
chmod($cpath . 'ReCodMod/databases/db0.sqlite', 0666);		
sleep (1);		
...
if($pravanadbchat1 != '0666')
chmod($cpath . 'ReCodMod/databases/db1.sqlite', 0666); 
  sleep (1);
...
if($pravanadbchat2 != '0666')
chmod($cpath . 'ReCodMod/databases/db2.sqlite', 0666); 
  sleep (1);
...
if($pravanadbchat3 != '0666')
chmod($cpath . 'ReCodMod/databases/db3.sqlite', 0666);
  sleep (1);
...
/*
if(!file_exists($cpath . 'ReCodMod/functions/geoip_bases/MaxMD/GeoLiteCity.dat')){		
		
$zip = new ZipArchive;
$res = $zip->open($cpath . 'ReCodMod/functions/geoip_bases/MaxMD/GeoLiteCity.zip');
if ($res === TRUE) {
  $zip->extractTo($cpath . 'ReCodMod/functions/geoip_bases/MaxMD/');
  $zip->close();
...
if(!file_exists($cpath.'ReCodMod/cache/x_cache/tempx1.txt'))
touch($cpath.'ReCodMod/cache/x_cache/tempx1.txt');

if(!file_exists($cpath.'ReCodMod/cache/x_cache/tempx2.txt'))
touch($cpath.'ReCodMod/cache/x_cache/tempx2.txt');

if(!file_exists($cpath.'ReCodMod/cache/x_cache/tempx3.txt'))
touch($cpath.'ReCodMod/cache/x_cache/tempx3.txt');

if(!file_exists($cpath.'ReCodMod/cache/x_cache/tempx4.txt'))
touch($cpath.'ReCodMod/cache/x_cache/tempx4.txt');

if(!file_exists($cpath.'ReCodMod/cache/x_cache/tempx5.txt'))
touch($cpath.'ReCodMod/cache/x_cache/tempx5.txt');

if(!file_exists($cpath.'ReCodMod/cache/x_cache/tempx6.txt'))
touch($cpath.'ReCodMod/cache/x_cache/tempx6.txt');

if(!file_exists($cpath.'ReCodMod/cache/x_cache/tempx7.txt'))
touch($cpath.'ReCodMod/cache/x_cache/tempx7.txt');	
