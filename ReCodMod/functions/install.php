...
if (!copy($cpath.'ReCodMod/functions/php.ini', $cpath.'php/php.ini')) 
	echo " \n \033[37;1;1m  <<< NO COPY ".$cpath."ReCodMod/functions/php.ini ... ! >>>   \n\n"; //red
else
...
chmod($cpath."ReCodMod/cache/x_cache/", 0777);
   ...
   // $zip = new Zip();
   // $zip->unzip_file($cpath."ReCodMod/geoip_bases/MaxMD/GeoLiteCity.zip");
   // $zip->unzip_to($cpath."ReCodMod/geoip_bases/MaxMD/");
