...
$ntodayz = 'Сегодня играло игроков: ';

$nocommand = 'Вы используете незарегистрированную команду, используйте';
$stats_top = 'Топ';
$stats_skill = 'Навык(а)';
$day_top = 'Топ дня';
$played_top = 'играет';
...
$loggmemb = 'вы в ^2Registered группе, ^3спасибо за регистрацию!';
$loggplayer = 'вы в ^2Guest группе, ^3спасибо за выход!';
...
$cnsorrd = 'Цензура!';
$cnsorrdsmz = 'перестань ругаться или тебя пнут от сюда';
$cnsorrdsmzjy = 'получает бан';
...
//another
$ban_name = "^3Тебя забанили Администраторы ^2".website."";
$ban_name_all = "^1Забанен ";
$ban_ip = "^Тебя забанили Администраторы ^2".website."";
$ban_ip_all = "^1Забанен ";
$c_unban = "^2Разбанен ";
